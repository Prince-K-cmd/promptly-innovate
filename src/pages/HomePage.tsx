...
import { BookOpen, PlusCircle, Zap, Loader2 } from 'lucide-react';
    ...
    <div className="container mx-auto py-8 px-4 max-w-7xl">
      ...
      <section className="mb-16 animate-slide-up" style={{ animationDelay: '300ms' }}>
        <div className="max-w-4xl mx-auto">
          ...
          {(() => {
            // Common wrapper div
            const wrapperClass = "bg-gradient-to-r from-promptiverse-purple/10 to-promptiverse-teal/10 p-1 rounded-xl";
      ...
      <section className="mb-16 animate-slide-up" style={{ animationDelay: '400ms' }}>
        ...
        {(() => {
          ...
          // No prompts
          const noPromptsMessage = isAuthenticated
          ...
          return (
            <div className="text-center py-16 bg-muted/30 rounded-lg">
              ...
              <p className="text-muted-foreground mb-6">{noPromptsMessage}</p>
              <Button asChild>
                <Link to="/create">
                  <PlusCircle className="mr-2 h-5 w-5" />
                  Create a Prompt
